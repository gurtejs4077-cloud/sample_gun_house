...
// Categories
const CATEGORIES = [
  { slug: 'pistols',           name: 'Pistols',          type: 'new',        division: 'main' },
  { slug: 'revolvers',         name: 'Revolvers',        type: 'new',        division: 'main' },
  { slug: 'rifles',            name: 'Rifles',           type: 'new',        division: 'main' },
  { slug: 'pre-owned',         name: 'Pre-owned',        type: 'pre-owned',  division: 'main' },
  { slug: 'ammunition',        name: 'Ammunition',       type: 'ammunition', division: 'main' },
  { slug: 'air-rifles',        name: 'Air Rifles',       type: 'new',        division: 'co2' },
  { slug: 'co2-guns',          name: 'CO2 Guns',         type: 'new',        division: 'co2' },
  { slug: 'holsters-carry',    name: 'Holsters & Carry', type: 'new',        division: 'co2' },
  { slug: 'optics',            name: 'Optics',           type: 'new',        division: 'co2' },
  { slug: 'cleaning',          name: 'Cleaning',         type: 'new',        division: 'co2' },
];
...
const PRODUCTS = [
  ...
  },
  {
    ...
    licenseRequired: true,
    licenseType: 'Form III / Arms License Required',
    priceInr: 4500000,
    caliber: '.177',
    capacity: '10 rounds',
    category: 'air-rifles',
  ...
  {
    id: 'pre-glock-17',
    slug: 'pre-owned-glock-17',
    name: 'Pre-owned Glock 17 Gen 4',
    shortDesc: 'Excellent condition Glock 17. Minimal holster wear.',
    licenseRequired: true,
    licenseType: 'Form III · Non-Prohibited Bore',
    priceInr: 18500000,
    caliber: '9×19mm',
    ...
    type: 'pre-owned',
    condition: 'excellent',
    brand: 'girsan', // Placeholder brand
    isFeatured: false,
    image: SVG_PISTOL_GOLD,
    createdAt: 1,
  },
  {
    id: 'pre-sw-686',
    slug: 'pre-owned-sw-686',
    name: 'Pre-owned S&W 686',
    shortDesc: 'Classic .357 Magnum revolver. Good condition.',
    licenseRequired: true,
    licenseType: 'Form III · Non-Prohibited Bore',
    priceInr: 15500000,
    caliber: '.357 Magnum',
    ...
    type: 'pre-owned',
    condition: 'good',
    brand: 'alfaproj', // Placeholder brand
    isFeatured: false,
    image: SVG_REVOLVER,
    createdAt: 2,
  },
...
// SVG Mapping for dynamic rendering
const SVG_MAP = {
  SVG_PISTOL_GOLD,
  SVG_REVOLVER,
  SVG_RIFLE,
